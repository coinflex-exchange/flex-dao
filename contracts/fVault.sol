...
contract fVault is ERC20 {
  ...
  constructor(address _token, address _governance, address _timelock, address _controller)
    ERC20(
      string(abi.encodePacked('flex ', ERC20(_token).name())),
  ...
  {
    return token.balanceOf(address(this)).add(
  ...
  /**
   * Overrides OpenZeppelin's default decimal value of 18 with the value set
   * during Contract Construction.
   * @dev This number will be equal to the decimals of `_token`'s decimals
   */
