...
// import '../interfaces/IVaultConverter.sol';
...
contract Controller
{
  ...
  // Function to swap between vaults
  function swapExactVaultForVault(
    ...
    IERC20(_fromVault).safeTransferFrom(msg.sender, address(this), _fromVaultAmount);
    ...
    uint256 _fromVaultAvailUnderlying = IERC20(_fromVaultToken).balanceOf(_fromVault);
    ...
    // Calculate fee
    uint256 _fromUnderlyingBalance = IERC20(_fromVaultToken).balanceOf(address(this));
