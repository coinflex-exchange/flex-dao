...
#*************************************************************
### Project Contracts ###
from brownie import FLEXCoin, fVault, StakingRewards
...
### Local Modules ###
from . import *
from .controller import deploy_controller # used by deploy_ve_flex
from .flex import deploy_flex
from .ve_flex import deploy_ve_flex
from .timelock import deploy_timelock # used by deploy_ve_flex

@fixture
def deploy_staking_rewards(admin: Account, deploy_flex: FLEXCoin, deploy_ve_flex: fVault) -> StakingRewards:
  '''
  ...
  :param: deploy_ve_flex  `fVault`  ERC-20 compliant Reward Token to be given out as rewards  
  :returns:  `StakingRewards`  
  '''
  flex: FLEXCoin  = deploy_flex
  ve_flex: fVault = deploy_ve_flex
...
def test_deploy_staking_rewards(admin: Account,  deploy_flex: FLEXCoin, deploy_ve_flex: fVault, gas_speed: str):
  '''
